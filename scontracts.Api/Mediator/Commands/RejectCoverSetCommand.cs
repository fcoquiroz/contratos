...
{
    public class RejectCoverSetCommand : RejectCoverSetRequest, IRequest<ResponseT<RejectCoverSetResponse>>
    {
        public RejectCoverSetCommand(RejectCoverSetRequest request)
        {
